...
const IndexPage = () => {
 ...
 که هم مشتری ها راضی باشن هم صاحبان کسب وکار</span>
    ...
    if (viewMode === 'mobile')
        ...
        return (
            <main className={'d-flex flex-column main-desktop  vw-100 '}>
                <div
                    className={'d-flex  justify-content-center main-desktop  align-items-center vh-100 vw-100 position-fixed '}>
                    ...
                    <div className={'left-side-desktop w-auto w-50'} style={{marginTop: '-250px'}}>
                        <div className={'intro-desktop-texts '}>
                            <h2 className={'intro-desktop-head mb-2 IransansBold'}>الان دیگه وقت <br/> راحت تر شدن
                                کارهاست
                            </h2>
                            <h5 className={'t-r mt-4 Iransans intro-desktop-title'}>کوکی برای رفع نیاز ها و سرعت دهی به
                                کار
                                ها طراحی شده
                                <br/>
